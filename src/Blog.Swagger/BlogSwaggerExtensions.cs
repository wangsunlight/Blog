    ...
    public static class BlogSwaggerExtensions
    {
        ...
        public static void UseSwaggerUI(this IApplicationBuilder app)
        {
            app.UseSwaggerUI(options =>
            {
                ...
                // API页面Title
                options.DocumentTitle = "😍接口文档 - 朝阳Blog⭐⭐⭐";
            });
        }
        ...
        /// Swagger描述信息
        /// </summary>
        private static readonly string description = @"<b>Blog</b>：<b>Hangfire</b>：<a target=""_blank"" href=""/hangfire"">任务调度中心</a> <code>Powered by .NET Core 3.1 on Linux</code>";
