using Blog.Application.Caching.HotNews;
using Blog.Application.Contracts.HotNews;
using Blog.Application.Contracts.HotNews.Params;
using Blog.Domain.HotNews.Repositories;
...
namespace Blog.Application.HotNews.Impl
{
